...
export class ShardingManager extends EventEmitter {
	...
	public on(event: SharderEvents.DISCONNECT, listener: (closeEvent: CloseEvent, shardID: number) => void): this;
	...
	public once(event: SharderEvents.DISCONNECT, listener: (closeEvent: CloseEvent, shardID: number) => void): this;
